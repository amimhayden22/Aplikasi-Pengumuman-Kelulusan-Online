...
<head>
  ...
  <title>Dashboard &mdash; APeK Online</title>
    ...
    <div class="main-wrapper">
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; {{ date('Y') }} <div class="bullet"></div> Coding By <a href="">Gus Khamim</a> & Design By <a href="https://nauval.in/">Muhamad Nauval Azhar</a>
        </div>
