                        ...
                        <form method="POST" action="{{ route('students.store') }}" class="needs-validation" novalidate="" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="attachment" type="text" class="form-control @error('attachment') is-invalid @enderror" name="attachment" value="{{ old('attachment') }}" required autocomplete="attachment">
                                    @if (count($errors) > 0)
                                        @error('attachment')
                                            <div class="invalid-feedback">
                                                {{ $message }}
